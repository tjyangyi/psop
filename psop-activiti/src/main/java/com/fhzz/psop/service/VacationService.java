...
import com.fhzz.psop.util.ActivitiUtil;
...
public class VacationService {
	private static Logger logger = LoggerFactory.getLogger(VacationService.class);
	...
	public Object myAudit(String userName) {
		...
		// Group group =
		// identityService.createGroupQuery().groupMember(userName).singleResult();
		// List<Task> list =
		// taskService.createTaskQuery().taskCandidateGroup(group.getId()).list();
